  ...
  return (
    <div className='lg:p-14 pt-12 lg:pt-20 p-4 bg-[#fafafa] lg:pb-36 pb-14'>
      ...
      <div className=' gap-3 grid-cols-[1fr_1fr_1.3fr] hidden lg:grid'>
        ...
        >
          <div className='bg-black/30  p-4 text-white w-80 flex items-center flex-col text-center'>
            ...
            <p>You are just a step away from owning the right to use these designs</p>
            <CustomButton text='Explore More' href='/onboarding' className='mt-8' />
          </div>
        </div>
        <div
      ...
      <div className='lg:hidden grid grid-cols-2 gap-3 mt-10'>
        <Image alt='img' src='/dev-images/exploreMobileImg1.png' radius='none' />
        <Image alt='img' src='/dev-images/exploreMobileImg2.png' radius='none' />
        <Image alt='img' src='/dev-images/exploreMobileImg3.png' radius='none' />
        <Image alt='img' src='/dev-images/exploreMobileImg4.png' radius='none' />
