            ...
            {(onClose) => (
              <ModalBody className="overflow-y-auto max-h-[90vh] custom-scrollbar">
                ...
                <div className="flex justify-start gap-4 mt-4">
                  ...
                  <CustomButton text="Submit Project" className="bg-[#CCE7F2] text-[#222222]" icon={<Image src={"/dev-images/Arrowup.png"} alt="submit" width={15} height={15} />} href={"/artist-page/submit-contract-congratulations"} />
                </div>
              </ModalBody>
            )}
          </ModalContent>
