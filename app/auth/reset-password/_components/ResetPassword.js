...
const ResetPassword = () => {
  ...
  const resetPasswordOTP = useAppStore((state) => state.resetPasswordOTP);
  console.log('EMAILLLLL:', requestForgotPasswordEmail);
  console.log('OTP:', resetPasswordOTP);
            ...
            <div className='space-y-2'>
              ...
              <div className='relative'>
                <input
                  ...
                  id='new-password'
                  className={`block w-full px-4 py-3 pr-12 border rounded-lg focus:outline-none sm:text-sm bg-[#FAFAFA] ${
                    showError
