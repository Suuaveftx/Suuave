        ...
        <div className='flex h-full items-end'>
          ...
          <div className='flex flex-col gap-20 items-start mb-10'>
            ...
            <p className='font-bold text-2xl text-[#EAEAEA] tracking-wide pr-4'>
              Connect, collaborate, and create the next generation of{' '}
              <span className='italic font-light'>African-inspired</span> fashion.
            </p>
          </div>
        </div>
      </section>
      <section className=' flex items-center justify-center h-screen lg:h-auto p-4 lg:p-0  w-full lg:w-3/6   '>
        ...
        <div className=' w-full lg:w-[70%] px-4 lg:px-10 flex flex-col justify-center items-center bg-white  border-2 border-gray-300 shadow-md rounded-lg'>
          <div className='mt-[45px]'>
            <Image src={'/dev-images/logo.png'} alt='logo' width={80} height={80} />
          </div>
