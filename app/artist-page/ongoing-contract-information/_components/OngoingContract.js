        ...
        <>
            ...
            <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 px-4 py-4 z-50 lg:hidden drop-shadow-xl">
                <div className="flex flex-row items-center justify-center gap-3 w-full">
                    <div className="flex-1 [&>button]:w-full [&>button]:h-[44px] [&>button]:text-[15px] [&>button]:rounded-full [&>button]:font-medium [&>button]:bg-[radial-gradient(circle,#EAF9FF_19%,#CCE7F2_100%)] [&>button]:text-[#035A7A]">
                        <SubmitProjectModal />
                    </div>
                    <div className="flex-1 [&>button]:w-full [&>button]:h-[44px] [&>button]:text-[15px] [&>button]:rounded-full [&>button]:border [&>button]:border-[#3A98BB] [&>button]:bg-transparent [&>button]:text-[#222222] [&>button]:font-medium">
                        <ChatClientModal clientName={clientProfile.name} />
                    </div>
                </div>
            </div>
