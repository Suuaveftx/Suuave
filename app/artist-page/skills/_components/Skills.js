        ...
        <Form className="w-full" validationBehavior="native" onSubmit={onSubmit}>
          ...
          <div className="mt-4 flex items-center gap-4">
            <Select
              ...
              variant="bordered"
              classNames={{
                trigger: 'bg-transparent border-[#D1D1D1] data-[hover=true]:!border-[#3A98BB] data-[focus=true]:!border-[#3A98BB] hover:!border-[#3A98BB] focus-within:!border-[#3A98BB] hover:!border-[1px] focus-within:!border-[1px] data-[hover=true]:!border-[1px] data-[focus=true]:!border-[1px]',
                value: 'text-black text-base'
              }}
              className="w-96"
            >
