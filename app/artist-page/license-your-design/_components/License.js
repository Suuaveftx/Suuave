    ...
    <div>
      <div className="lg:w-full w-full max-w-[90%] px-6 py-2 lg:mx-16 mx-4 mt-8 rounded-lg bg-gradient-to-b from-[#CCE7F2] via-[#A1DCF3] to-[#49C0F0] text-[#393939]">
        ...
        <p className="text-base text-[#393939]">
          Ensure you are the original creator or rightful owner of the design
          you wish to upload. Uploading someone else’s work without permission
          may infringe their copyright. By uploading, you confirm you have the
      ...
      <div className="bg-[#FAFAFA] border-1 border-[#DDDDDD]  w-full max-w-[90%] text-[#222222] lg:mx-16 mx-4 px-6 pt-[24px] pb-[32px] mt-7 mb-[99px] flex flex-col gap-6 rounded-[8px]">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm">
            Uploading different views (e.g., front, back, and side views) helps
        ...
        <div className="flex flex-col gap-2">
          ...
          <Input
            placeholder="0.0 $"
            className="border-2 border-[#d1d1d1] rounded-lg lg:w-full lg:max-w-[50%]"
          />
        </div>
        ...
        <div className="flex items-start gap-2">
          <Checkbox />
          <p className="text-sm">
            By publishing, you confirm you have the necessary rights and
            permission to the ownership of this design.{" "}
