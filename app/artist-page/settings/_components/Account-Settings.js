                ...
                <CardBody className='p-6 flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col gap-3'>
                        <div className='flex items-center gap-2'>
                            ...
                            <span className='text-sm font-semibold text-[#222222]'>Ocean Clara</span>
                        </div>
                        <div className='flex items-center gap-2'>
                            <span className='text-sm text-[#767676] w-16'>Email -</span>
                            <span className='text-sm font-semibold text-[#222222]'>oce****ra@gmail.com</span>
                        </div>
                        <div className='flex items-center gap-2'>
                                ...
                                <>
                                    ...
                                    <ModalBody className='pb-2'>
                                        <p className='text-sm text-[#767676] text-center'>
                                            ...
                                            <span className='font-semibold'>oce****ra@gmail.com</span> to delete your account.
                                        </p>
