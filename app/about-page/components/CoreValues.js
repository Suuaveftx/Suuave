    ...
    <section className="py-16 bg-[#002938]">
      <div className="container mx-auto px-6 lg:px-8">
        <div className="flex items-center mb-8">
          <h2 className="text-xl font-semibold text-[#CCD6F6] mr-4 bg-[#004967] p-2">
            OUR CORE VALUES
          </h2>
          <div className=""></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-[#002938] rounded-lg p-6 lg:p-8 border border-[#D1D1D1]">
            <div className="w-10 h-10 rounded-full bg-[#64FFDA1A] text-[#64FFDA] flex items-center justify-center mb-4">
              <Image src="/icons/003.svg" alt="" width={500} height={500} />
            </div>
            <h3 className="text-lg font-semibold text-[#3A98BB] mb-2">
              RELIABILITY
            </h3>
          ...
          <div className="bg-[#002938] rounded-lg p-6 lg:p-8 border border-[#D1D1D1]">
            <div className="w-10 h-10 rounded-full bg-[#64FFDA1A] text-[#64FFDA] flex items-center justify-center mb-4">
              <Image src="/icons/001.svg" alt="" width={500} height={500} />
            </div>
            <h3 className="text-lg font-semibold text-[#3A98BB] mb-2">
              INCLUSIVITY
            </h3>
          ...
          <div className="bg-[#002938] rounded-lg p-6 lg:p-8 border border-[#D1D1D1]">
            <div className="w-10 h-10 rounded-full bg-[#64FFDA1A] text-[#64FFDA] flex items-center justify-center mb-4">
              <Image src="/icons/002.svg" alt="" width={500} height={500} />
            </div>
            <h3 className="text-lg font-semibold text-[#3A98BB] mb-2">
              COLLABORATION
            </h3>
