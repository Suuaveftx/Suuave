...
const ProductGallery = ({ images, title, onOpenDetails, isBookmarked, onToggleSave }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 bg-white rounded-[32px] overflow-hidden p-0 lg:py-4 lg:pr-4 lg:pl-6 h-auto lg:h-[680px]">
      ...
      {/* Main Display Area */}
      <motion.div
        className="flex-1 relative bg-neutral-100 lg:rounded-[32px] overflow-hidden aspect-[3/4] lg:aspect-auto cursor-pointer group origin-top shadow-xl transition-shadow"
      >
