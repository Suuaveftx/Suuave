          ...
          <CardBody className='space-y-6'>
            ...
            <div className='space-y-4 text-sm '>
              <div className='border-b border-gray-300 pb-4'>
                ...
                <p>
                  ...
                  opportunities to continue working with them on future projects.
                </p>
              </div>
              ...
              <div className='border-b border-gray-300 pb-4'>
                ...
                <p>
                  A one-time payment of <strong>$5</strong> grants you life-time access to
                  directly work with artist anytime you wish.
                </p>
              </div>
            ...
            <div className='flex flex-col-reverse md:flex-row  gap-4 pt-4'>
              ...
              <Button
                ...
                size='md'
              >
                Retain {artist && artist.charAt(0).toUpperCase() + artist.slice(1)}
              </Button>
            </div>
          </CardBody>
        </Card>
