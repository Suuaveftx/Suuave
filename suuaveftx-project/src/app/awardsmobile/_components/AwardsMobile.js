  ...
  return (
    ...
    <div className="sm:hidden flex flex-col items-center bg-[#FAFAFA] px-4 py-6 space-y-8 w-full min-h-screen overflow-y-auto">
      ...
      <div className="w-full space-y-2 mb-[24px] text-left">
        <h1 className="text-[22px] font-bold text-[#444444]">Awards/Certification (Optional)</h1>
        <p className="text-sm text-gray-500">Add any related Awards/Certification you acquired</p>
      </div>

      {/* Name of Award/Certificate Input */}
      <div className="space-y-2 mb-[16px] w-full">
        <label className="text-[16px] font-medium text-[#444444]" htmlFor="awardName">
      ...
      <div className="space-y-2 mb-[16px] w-full">
        <label className="text-[16px] font-medium text-[#444444]" htmlFor="issuedBy">
          Awarded/Issued by
        </label>
        <input
          type="text"
      ...
      <div className="space-y-2 mb-[24px] w-full">
        <label className="text-[16px] font-medium text-[#444444]" htmlFor="certificateUpload">
